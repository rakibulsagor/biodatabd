document.addEventListener('DOMContentLoaded', () => {
    ...
    const schema = {
        personal: [
            { id: 'fullName', label:নাম' },
            { id: 'gender', label:লিঙ্গ' },
            { id: 'age', label:বয়স' },
            { id: 'height', label:উচ্চতা' },
            { id: 'bloodGroup', label:রক্ত' },
            { id: 'job', label:পেশা' },
            { id: 'salary', label:আয়' },
            { id: 'maritalStatus', label:বৈবাহিক অবস্থা' }
        ],
        family: [
            { id: 'fatherName', label:পিতা' },
            { id: 'fatherWork', label: "পিতার পেশা" },
            { id: 'motherName', label:মাতা' },
            { id: 'motherWork', label: "মাতার পেশা" },
            { id: 'parentsIncome', label: "পিতা-মাতার আয়" },
            { id: 'familyMembers', label:সদস্য সংখ্যা' }
        ],
        contact: [
            { id: 'presentAddress', label:বর্তমান ঠিকানা' }
        ]
    };
    ...
    document.getElementById('add-edu-btn').addEventListener('click', () => {
        ...
        div.innerHTML = `
            <div class="input-field">
                <label>Qualification Name (E.g. S.S.সমমান)</label>
